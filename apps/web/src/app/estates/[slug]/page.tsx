...
const getEstate = cache(async (slug: string) => {
  try { const api = await getServerApiClient(); return await api.land.getPublished({ slug }) as Record<string, unknown>; }
  catch { notFound(); }
});
