        ...
        <div className="flex h-14 items-center justify-between px-3.5 border-b border-black/[0.06] dark:border-white/[0.06]">
          {!collapsed ? (
            ...
            >
              ...
              <span className="rounded-full bg-brand-gold-500/20 px-1.5 py-0.5 text-[10px] font-semibold text-brand-gold-700 dark:text-brand-gold-300">
                Buyer
              </span>
            </Link>
          ) : (
