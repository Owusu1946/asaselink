...
const titles: Record<string, string> = { "/admin": "Company reviews", "/admin/estates": "Estate publishing", "/admin/users": "User access", "/admin/audit": "Audit trail", "/admin/operations": "Operations", "/admin/finance": "Payments & payouts" };
