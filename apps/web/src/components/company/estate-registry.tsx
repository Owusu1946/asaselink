...
interface EstateSummary { id: string; name: string; slug: string; region: string; district: string | null; status: string; priceFrom: string | null }
